...
export function Hero() {
  return (
    <section className="relative h-[80vh] flex items-center justify-center text-center bg-[#212529]">
      {/* Background image placeholder - Using a dark overlay for now */}
      <div className="absolute inset-0 bg-[#000000] opacity-70"></div>
      
      <div className="relative z-10 space-y-8 max-w-4xl px-8">
        <h1 className="text-[80px] font-serif text-white leading-[88px] font-bold">
